    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-invert prose-gray max-w-none space-y-8">
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">14-Day Money-Back Guarantee</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">How to Request a Refund</h2>
            <p className="text-gray-600 dark:text-gray-400">
              Email us at{" "}
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">After 14 Days</h2>
            <p className="text-gray-600 dark:text-gray-400">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Questions?</h2>
            <p className="text-gray-600 dark:text-gray-400">
              Contact us at{" "}
              <a href="mailto:support@cronowl.com" className="text-blue-400 hover:text-blue-300">
                support@cronowl.com
      ...
      <footer className="border-t border-gray-200 dark:border-gray-800 py-8 mt-12">
        <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6 text-sm">
            ...
            <Link href="/refund" className="text-gray-900 dark:text-white">
              Refund
            </Link>
          </div>
        </div>
