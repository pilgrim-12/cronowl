...
function CodeBlock({ children, title }: { children: string; title?: string }) {
  return (
    <div className="bg-gray-100 dark:bg-gray-950 rounded-lg overflow-hidden">
      {title && (
        <div className="bg-gray-200 dark:bg-gray-900 px-4 py-2 text-sm text-gray-600 dark:text-gray-400 border-b border-gray-300 dark:border-gray-800">
          {title}
        </div>
      )}
...
function Endpoint({
  ...
  return (
    <div className="border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden mb-6">
      <div className="bg-gray-100 dark:bg-gray-900 px-4 py-3 flex items-center gap-3">
        <span className={`px-2 py-1 rounded text-xs font-bold ${methodColors[method]}`}>
          {method}
        </span>
        <code className="text-gray-900 dark:text-white font-mono">{path}</code>
      </div>
      <div className="p-4">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
            <Link href="/" className="hover:text-gray-700 dark:hover:text-gray-400">Home</Link>
            <span>/</span>
            <span className="text-gray-600 dark:text-gray-400">API Documentation</span>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6 mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Go to <Link href="/settings" className="text-blue-500 dark:text-blue-400 hover:underline">Settings</Link> and
...
{`Authorization: Bearer sk_live_xxxxxxxxxxxx`}
        ...
        {/* Response Format */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Response Format</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-4">All responses are JSON with this structure:</p>
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <h4 className="text-gray-900 dark:text-white font-medium mb-2">Success</h4>
              <CodeBlock>
{`{
  "success": true,
  "data": { ... },
  "meta": {
    ...
    "total": 45
            ...
            <div>
              <h4 className="text-gray-900 dark:text-white font-medium mb-2">Error</h4>
              <CodeBlock>
{`{
  "success": false,
  "error": {
...
{`{
  ...
  "data": { "revoked": true }
        ...
        {/* Checks Endpoints */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Checks</h2>
...
{`{
  ...
  "meta": {
    ...
    "count": 2
        ...
        {/* Ping Endpoint */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Ping Endpoint</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
...
curl "https://cronowl.com/api/ping/your-slug?duration=$DURATION&exit_code=$?"`}
        ...
        {/* Postman */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Testing with Postman</h2>
        ...
        <section className="mb-12">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-800">
                <th className="text-left py-3 text-gray-500 dark:text-gray-400">Code</th>
                <th className="text-left py-3 text-gray-500 dark:text-gray-400">HTTP Status</th>
                <th className="text-left py-3 text-gray-500 dark:text-gray-400">Description</th>
              </tr>
            </thead>
            <tbody className="text-gray-700 dark:text-gray-300">
              <tr className="border-b border-gray-200 dark:border-gray-800">
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-8 mt-12">
          <p className="text-gray-500 text-center">
            ...
            <a href="mailto:support@cronowl.com" className="text-blue-500 dark:text-blue-400 hover:underline">
              support@cronowl.com
            </a>
          </p>
        </div>
