  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-500 dark:text-gray-500 mb-8">Last updated: December 17, 2025</p>

        <div className="prose prose-invert prose-gray max-w-none space-y-8">
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">The Service</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Your Account</h2>
            <p className="text-gray-600 dark:text-gray-400">
          ...
          <section>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-3">Don&apos;t use CronOwl to:</p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Payments</h2>
            <p className="text-gray-600 dark:text-gray-400">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Termination</h2>
            <p className="text-gray-600 dark:text-gray-400">
      ...
      <footer className="border-t border-gray-200 dark:border-gray-800 py-8 mt-12">
        <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6 text-sm">
            <Link href="/pricing" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
              Pricing
            </Link>
            <Link href="/terms" className="text-gray-900 dark:text-white">
              Terms
            </Link>
            <Link href="/privacy" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
              Privacy
            </Link>
            <Link href="/refund" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
              Refund
            </Link>
          </div>
        </div>
