...
export default function SettingsPage() {
  ...
  const handleRestartTour = async () => {
    ...
    try {
      await restartOnboardingTour(user.uid);
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6 mb-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between py-2">
              <div>
                <span className="text-gray-900 dark:text-white block">Onboarding Tour</span>
                <span className="text-gray-500 dark:text-gray-400 text-sm">Learn how to use CronOwl</span>
              </div>
              <button
              ...
              >
                {restartingTour ? "Starting..." : "Restart Tour"}
              </button>
            </div>
          </div>
        </div>
