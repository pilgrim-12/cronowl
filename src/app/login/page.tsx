        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-8 space-y-6">
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-100 text-gray-900 border border-gray-300 dark:border-gray-200 rounded-lg px-4 py-2.5 font-medium hover:bg-gray-50 dark:hover:bg-gray-200 transition-colors disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-gray-800 dark:bg-gray-700 text-white rounded-lg px-4 py-2.5 font-medium hover:bg-gray-700 dark:hover:bg-gray-600 transition-colors disabled:opacity-50"
            >
          ...
          <p className="text-center text-gray-500 dark:text-gray-400 text-sm">
            ...
            <Link href="/signup" className="text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300">
              Sign up
            </Link>
          </p>
        </div>
