        ...
        <div className="bg-gray-900 rounded-lg p-8 space-y-6">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 rounded-lg px-4 py-2.5 font-medium hover:bg-gray-100 transition-colors"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-gray-800 text-white rounded-lg px-4 py-2.5 font-medium hover:bg-gray-700 transition-colors"
            >
