    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-8 space-y-6 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              We&apos;ve sent a verification link to <span className="text-gray-900 dark:text-white font-medium">{email}</span>.
            ...
            <div className="pt-4 space-y-3">
              ...
              <p className="text-gray-500 text-sm">
                ...
                <Link href="/login" className="text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300">
                  sign in
                </Link>{" "}
                to resend.
              </p>
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-8 space-y-6">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-100 text-gray-900 border border-gray-300 dark:border-gray-200 rounded-lg px-4 py-2.5 font-medium hover:bg-gray-50 dark:hover:bg-gray-200 transition-colors"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-gray-800 dark:bg-gray-700 text-white rounded-lg px-4 py-2.5 font-medium hover:bg-gray-700 dark:hover:bg-gray-600 transition-colors"
            >
