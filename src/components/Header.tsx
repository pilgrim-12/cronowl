    ...
    <header className="border-b border-gray-200 bg-gray-50/80 dark:border-gray-800 dark:bg-gray-950/80 backdrop-blur-sm sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Dropdown menu */}
          {isMenuOpen && (
            <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg shadow-lg py-1 animate-in fade-in slide-in-from-top-2 duration-150">
              {/* User info */}
              ...
              <div className="py-1 sm:hidden border-b border-gray-200 dark:border-gray-800">
                <Link
                  href="/dashboard"
